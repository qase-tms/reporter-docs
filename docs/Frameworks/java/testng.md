...
next:
  description: ''
---
The `qase-testng-reporter` allows you to automatically upload your **TestNG** test execution results to your Qase project. It integrates directly with TestNG’s test lifecycle, capturing detailed information about test statuses and sending it to Qase through the public API. This makes it easy to track both automated and manual testing efforts in one place, providing better visibility into your project’s overall quality and simplifying reporting workflows.
...
dependencies {
   ...
   testImplementation 'io.qase:qase-testng-reporter:4.1.5'
...
In the above command, we’re setting the reporter’s mode with `QASE_MODE`.
